...
_Part 0 is an overview and executive summary. No primary evidence items originate here; evidence supports claims developed in Parts 1–8._

## Evidence Gaps

_Not applicable — claims are developed and evidenced in subsequent parts._

## Navigation

| Previous | Up | Next |
|---|---|---|
| — | [Project Root](../../README.md) | [Part 1: Two Futures](../01-two-futures/) |
